...
public class dayIndScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        timeChecker();
        changePoint = GameManager.Instance.dayLenght / 4;
    }
    void FixedUpdate()
    {
        timeChecker();
    ...
    private void timeChecker()
    {
        ...
        else if (GameManager.Instance.dayProgression > changePoint && GameManager.Instance.dayProgression < changePoint * 2)
        {
            GetComponent<Image>().sprite = img2;
        }
        else if (GameManager.Instance.dayProgression > changePoint * 2 && GameManager.Instance.dayProgression < changePoint * 3)
        {
            GetComponent<Image>().sprite = img3;
        }
        else if (GameManager.Instance.dayProgression > changePoint * 3)
        {
